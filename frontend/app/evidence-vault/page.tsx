        ...
        <div className="flex min-h-screen items-center justify-center bg-black">
            ...
            >
                <div className="relative h-full w-full bg-black flex flex-col items-center justify-center p-8">
                    <h1 className="text-white text-4xl font-bold mb-8">Safety Info</h1>
                    <p className="text-gray-400 text-center mb-8">Safety information and resources will be displayed here</p>
